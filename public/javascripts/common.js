...
function setlocal(n, v) {window.localStorage ? localStorage.setItem(CKPrex + n, v) : set_cookie(n, v);}
function getlocal(n) {return window.localStorage ? localStorage.getItem(CKPrex + n) : get_cookie(n);}
